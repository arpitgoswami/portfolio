function Main() {
   return (
      <>
         <div id="about-container" className="mx-60 my-40 sm:mx-6">
            <p className="my-6 text-8xl sm:text-5xl">About</p>
            <div className="grid grid-cols-2 gap-8 sm:grid-cols-1">
               <div>
                  <p className="my-8 text-slate-300 ">
                     I’m Chris Lee, a front-end web developer and Web Page
                     Designer based in New York, USA. I've been working for the
                     last 10 years.
                     <br />
                     <br />
                  ...
                  <a href="">
                     <p className="block w-36 border-2 bg-black py-1 text-center text-white">
                        About Me
                     </p>
                  </a>
               </div>
         ...
         <div className="mx-60 sm:mx-6">
            <p className="my-6 text-center text-8xl sm:text-5xl">Portfolio</p>
